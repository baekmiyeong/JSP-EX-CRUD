...
<body>
	<%
		...
		if (request.getParameter("kiTitle") == null || request.getParameter("kiContent") == null ||
				request.getParameter("kiTitle").equals("") || request.getParameter("kiContent").equals("")) {
			PrintWriter script = response.getWriter();
			script.println("<script>");
			...
			int result = kiDAO.update(kiID, request.getParameter("kiTitle") , request.getParameter("kiContent"));
